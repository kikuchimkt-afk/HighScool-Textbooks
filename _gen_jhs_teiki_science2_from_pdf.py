# -*- coding: utf-8 -*-
"""
定期テスト対策ワーク 中2理科 — PDF をビューア用 PNG にレンダリングする。

既定ソース: D:\\Files\\(2025)定期テスト対策ワーク\\中2理科 内の最新 .pdf
出力: images/jhs_teiki_science2/page_0001.png …
...
DEFAULT_SRC_DIR = Path(r"D:\Files\(2025)定期テスト対策ワーク\中2理科")
OUT_DIR = ROOT / "images" / "jhs_teiki_science2"
ZOOM = 2.0
...
def main() -> int:
    ...
    print(f"totalPages を {n} に設定: js/jhs_data.js の jhs_teiki_science2")
    return 0
