"""
中2数学: 本冊PDFの1ページ目を表紙として書き出し、page_0001 と一致させる。
ファビコン／PWA用アイコンは表紙の上半分をトリミングしてから正方形にフィットする。

Requires: PyMuPDF (fitz), Pillow

PDF: JHS_MATH2_PDF_DIR または既定 D:\\Files\\(2025)iワーク\\中2数学\\中2数学.pdf
"""
...
PDF_DIR = Path(os.environ.get("JHS_MATH2_PDF_DIR", r"D:\Files\(2025)iワーク\中2数学"))
MAIN_PDF = PDF_DIR / "中2数学.pdf"
COVER_OUT = ROOT / "images" / "jhs_iwork_math2_cover.png"
PAGE1_OUT = ROOT / "images" / "jhs_iwork_math2" / "page_0001.png"
ICON_DIR = ROOT / "icons"
