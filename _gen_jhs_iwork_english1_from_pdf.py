# -*- coding: utf-8 -*-
"""
iワーク 中1英語 — 4 つの PDF を結合してビューア用 PNG にレンダリングする。

既定ソース: D:\\Files\\(2025)iワーク\\中1英語

  本冊         中1英語.pdf              180 pp  → page_0001 〜 page_0180
  解答解説      中1英語_解答解説.pdf     88 pp  → page_0181 〜 page_0268
  プラス        中1英語_プラス.pdf       71 pp  → page_0269 〜 page_0339
  プラス解答    中1英語_プラス_解答解説.pdf 33 pp → page_0340 〜 page_0372
...
DEFAULT_SRC_DIR = Path(r"D:\Files\(2025)iワーク\中1英語")
OUT_DIR = ROOT / "images" / "jhs_iwork_english1"
ZOOM = 2.0
...
def main() -> int:
    ...
    print(f"totalPages を {global_page} に設定: js/jhs_data.js の jhs_iwork_english1")
    return 0
